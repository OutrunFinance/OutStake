 ...
 * @title Outrun USDB
 */
contract ORUSD is IORUSD, ERC20, Initializable, Ownable, GasManagerable {
    ...
    constructor(address owner, address gasManager) ERC20("Outrun USDB", "orUSD") Ownable(owner) GasManagerable(gasManager) {}
