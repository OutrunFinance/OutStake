...
contract OutrunERC4626YieldTokenOnBlast is IYieldManager, OutrunYieldToken, ReentrancyGuard, GasManagerable, Ownable {
    ...
    ) OutrunYieldToken(name_, symbol_, decimals_) GasManagerable(gasManager_) Ownable(owner_) {
